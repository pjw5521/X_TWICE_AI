...
if __name__ == '__main__':
    ...
    path_rotate = '../test/rotate'
    path_rotate1 = '../test/rotate1'
    path_rotate2 = '../test/rotate2'
    path_rotate3 = '../test/rotate3'
    path_rotate4 = '../test/rotate4'
    path_rotate5 = '../test/rotate5'
    path_rotate6 = '../test/rotate6'
    path_mirror = '../test/mirror'
    path_bright = '../test/bright'
    path_dark = '../test/dark'
    path_flip = '../test/filp'
